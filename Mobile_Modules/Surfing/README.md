...
### 📝 config.yaml
- **大小**: 18.9 KB
- **链接**: [查看源码](https://github.com/MARSCHIAO/mihomo_yamls/blob/main/Mobile_Modules/Surfing/config.yaml)
...
| 文件名 | 大小 | 链接 |
| :--- | :--- | :--- |
| `config.yaml` | 18.9 KB | [查看](https://github.com/MARSCHIAO/mihomo_yamls/blob/main/Mobile_Modules/Surfing/config.yaml) |