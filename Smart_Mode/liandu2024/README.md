...
| 文件名 | 大小 | 链接 |
| :--- | :--- | :--- |
| `clash-all-fallback-smart.yaml` | 18.2 KB | [查看](https://github.com/MARSCHIAO/mihomo_yamls/blob/main/Smart_Mode/liandu2024/clash-all-fallback-smart.yaml) |
| `clash-all-smart.yaml` | 15.1 KB | [查看](https://github.com/MARSCHIAO/mihomo_yamls/blob/main/Smart_Mode/liandu2024/clash-all-smart.yaml) |
| `clash-fallback-smart-std.yaml` | 17.7 KB | [查看](https://github.com/MARSCHIAO/mihomo_yamls/blob/main/Smart_Mode/liandu2024/clash-fallback-smart-std.yaml) |